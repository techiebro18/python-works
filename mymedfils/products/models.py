...
class ProductTab(models.Model):
    ...
    uses = RichTextUploadingField(blank=True)
    warnings = RichTextUploadingField(blank=True)
    interactions = RichTextUploadingField(blank=True)
    directions = RichTextUploadingField(blank=True)
    side_effects = RichTextUploadingField(blank=True)
    more_information = RichTextUploadingField(blank=True)
